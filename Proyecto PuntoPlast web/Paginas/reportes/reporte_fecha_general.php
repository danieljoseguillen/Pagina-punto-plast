...
// Carga de datos
$pdf->AddPage();
$result=mysqli_query($con,'SELECT Num_ped, Ci_clie, Fecha_ped, Estado_ped, SUM(Cant_prod_ped) as cantidad, SUM(Precio_cant_ped) as total FROM `pedido` inner join pedido_producto using(Num_ped) group by Num_ped order by Num_ped');
$pdf->SetTitle($title);
$data=$result;
