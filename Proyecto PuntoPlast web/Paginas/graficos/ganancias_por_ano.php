...
$result=mysqli_query($con,'SELECT (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="01") as enero, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="02") as febrero, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="03") as marzo, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="04") as abril, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="05") as mayo, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="06") as junio, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="07") as julio, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="08") as agosto, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="09") as septiembre, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="10") as octubre, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="11") as noviembre, (SELECT SUM(Precio_cant_ped) FROM pedido INNER JOIN pedido_producto USING(Num_ped) WHERE Estado_ped="Procesado" AND YEAR(Fecha_ped)="'.$year.'" AND MONTH(Fecha_ped)="12") as diciembre');
...
$grafico->img->SetMargin(70,10,50,90);
$grafico->title->Set("Ganancias para el año ".$year);
...
$grafico->yaxis->title->Set("Ganancias");
$grafico->yaxis->title->SetFont(FF_ARIAL,FS_BOLD,10);
$grafico->yaxis->SetTitleMargin(60);
