...
<body>
  ...
  <div class="contenedoracord">
   ...
   <header class="titulo">Usuarios - Actividad</header>
       <br> <br>
       <form action="">
        <div>Buscar
    ...
    $result = $Procesos->list_activity($id);

    ?>
          <table id="myTable">
       <tr>
        <th style="cursor: pointer;" onclick="sortTable(0)">ID</th> 
        <th width="25%" style="cursor: pointer;" onclick="sortTable(1)">Usuario</th> 
        <th width="25%" style="cursor: pointer;" onclick="sortTable(2)">Actividad</th> 
        <th width="25%" style="cursor: pointer;" onclick="sortTable(3)">Objetivo</th> 
        <th width="25%" style="cursor: pointer;" onclick="sortTable(4)">Fecha</th> 
        </tr>
        <?php
        ...
        <td><?php echo $row['Objetivo_actividad']; ?></td>
