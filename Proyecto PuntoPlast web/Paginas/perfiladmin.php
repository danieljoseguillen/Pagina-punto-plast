...
<body>
   ...
   <header class="titulo">Mi Perfil - Administrador</header>
       <br>
        <?php
    ...
    $sesion=$Procesos->session();
       ...
       <table>
        ...
        <td align= center> <?php echo  $result['Id_usu']; ?></td>
        </tr>
           <tr>
        <td class="t1">Correo: </td> 
        <td align= center> <?php echo  $result['Email_usu']; ?></td>    
        </tr>
       </table>
        <br><br>
       <form action="perfiladmineditar.php">
